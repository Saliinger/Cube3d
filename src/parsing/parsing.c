...
/*   Updated: 2025/01/21 02:38:50 by jalbiser         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int verify_data(t_data *data, int i)
{
...
int parser(char *file, t_data *data)
{
	...
	data->map[z] = NULL;
    close(fd);
    return (verify_data(data, 1));  // Fonction à ajouter pour vérifier que toutes les données sont présentes
}
